...
def main():
    myself = InstagramAPI(keys.username, keys.password)
    myself.login()  # login
    dt = datetime.datetime.now(tz=EST5EDT())
    print(dt.strftime("%I:%M"))
    t = dt.strftime("%I:%M")
    mybio = "If you're reading this at " + t + ", this is a sign"
    print(myself.editProfile(keys.website, keys.phone, keys.name, mybio,"",""))
